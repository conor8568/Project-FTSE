...
The following datasets are produced during the data preparation stage:
  ...
  - returns_daily.csv
    Daily log returns computed from adjusted prices. Used for volatility and correlation analysis.
	- returns_monthly.csv
...
Two simple benchmark portfolios are constructed:
	...
	- Minimum-variance portfolio (long-only, weights sum to one)
...
This period captures multiple distinct regimes:
  - Lower rate, QE-driven markets from 2015–2019
  - COVID shock and recovery from 2020–2021
  - Inflation, rate hikes, and elevated volatility from 2022–2024 
...
## Key Findings
  ...
  - Correlation structure helps explain portfolio risk reduction
